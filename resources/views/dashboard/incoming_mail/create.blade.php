            ...
            <div class="row">
                ...
                <div class="col-6 mb-3">
                    ...
                    <input class="form-control small @error('mail_date') is-invalid @enderror"
                        id="exampleFormControlInput2" type="date" name="mail_date" value="{{ old('mail_date') }}">
            ...
            <div class="row">
                <div class="col-6 mb-3">
                    ...
                    <input class="form-control small @error('mail_number') is-invalid @enderror"
                        id="exampleFormControlInput3" type="text" name="mail_number" value="{{ old('mail_number') }}">
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    ...
                    <input class="form-control small @error('mail_from') is-invalid @enderror"
                        id="exampleFormControlInput5" type="text" name="mail_from" value="{{ old('mail_from') }}">
