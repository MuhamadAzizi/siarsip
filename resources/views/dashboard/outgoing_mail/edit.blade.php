...
<div class="card shadow">
    ...
    <form action="{{ route('surat-keluar.update', $outgoing_mail->id) }}" method="post">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row">
                <div class="col-6 mb-3">
                    ...
                    <input class="form-control small @error('mail_date') is-invalid @enderror"
                        id="exampleFormControlInput1" type="date" name="mail_date"
                        value="{{ $outgoing_mail->mail_date }}">
                ...
                <div class="col-6 mb-3">
                    ...
                    <input class="form-control small @error('mail_number') is-invalid @enderror"
                        id="exampleFormControlInput2" type="text" name="mail_number"
                        value="{{ $outgoing_mail->mail_number }}">
            ...
            <div class="row">
                <div class="col-6 mb-3">
                    ...
                    <input class="form-control small @error('notes') is-invalid @enderror" id="exampleFormControlInput3"
                        type="text" name="notes" value="{{ $outgoing_mail->notes }}">
                ...
                <div class="col-6 mb-3">
                    ...
                    <input class="form-control small @error('mail_to') is-invalid @enderror"
                        id="exampleFormControlInput4" type="text" name="mail_to" value="{{ $outgoing_mail->mail_to }}">
            ...
            <div class="row">
                <div class="col-12 mb-0">
                    ...
                    <textarea class="form-control small @error('mail_subject') is-invalid @enderror"
                        ...
                        name="mail_subject">{{ $outgoing_mail->mail_subject }}</textarea>
